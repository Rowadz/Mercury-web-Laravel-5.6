                            ...
                            <form action="{{ route('register') }}" class="col s12" method="POST" id="registerForm">
                                @csrf
                                    <div class="input-field col s12 m6" data-aos="flip-down">
                                        ...
                                        <input id="name" type="text" class="validate white-text" required name='name'
                                    ...
                                    <div class="input-field col s12 m6 ">
                                        ...
                                        <input id="phone" type="number" class="validate white-text" required name="phone"
                                ...
                                <button class="btn waves-effect waves-light z-depth-5 hoverable grey darken-3" type="submit"
                                    name="action" id="registerButton"> {{ __('Register') }}
