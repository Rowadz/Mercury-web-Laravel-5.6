...
<section class="mainLogin2 fixParticlesIssue" id="registerPage">
                ...
                <div class="row  ">
                   <div class="col s12 m12 inputs">
                      <div class="col s12 m6 white-text" data-aos="fade-right">
                            <a href="{{route('wlcome')}}" class="btn-floating btn-large waves-effect waves-light deep-orange accent-4 hoverable tooltipped" data-position="top" data-tooltip="Return">
                                <i class="material-icons">arrow_back</i>
                            </a>
                            <a href="/login" class="btn-floating btn-large waves-effect waves-light yellow accent-4 hoverable tooltipped" data-position="top" data-tooltip="Login">
