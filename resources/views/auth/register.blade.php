      ...
      <div class="row fixParticlesIssue">
         <div class="col s12 m12 ">
            <div class="container white-text flow-text  z-depth-5 hoverable mainResgister ">
               ...
               {{-- 
               <p class="inputs white-text">You don't need to provide everything, <span class="blue-text text-lighten-3">blue</span>  is required </p>
               --}}
               <div class="row  ">
                  <div class="col s12 m12 inputs">
                     <div class="col s12 m6 white-text" data-aos="fade-right">
                        <a href="{{route('wlcome')}}" class="btn-floating btn-large waves-effect waves-light black hoverable tooltipped" data-position="top" data-tooltip="Return">
                        <i class="material-icons deep-orange-text text-accent-4 ">home</i>
                        </a>
                        <a href="/login" class="btn-floating btn-large waves-effect waves-light black hoverable tooltipped" data-position="top" data-tooltip="Login">
                     ...
                     <div class="col s12 m6 white-text" data-aos="fade-left">
                        ...
                        <a class="waves-effect waves-light btn black z-depth-5 hoverable red-text text-accent-2">Google +</a>
                     </div>
                  </div>
               </div>
