  ...
  <div class="ui feed" style="padding-left: 20px;">
    <div class="event">
      <div class="label">
        ...
        <img src="{{ $post->user->image }}" onerror="brokenImageHandling(this)" onload="removeLoader()" onabort="removeLoader()">
      </div>
      <div class="content">
        <div class="date">
          <a href="/@/{{ $post->user->name }}">
  ...
  <div class="ui relaxed stackable grid">
    <div class="three column row">
      ...
      <div class="column">
        ...
        <img class="ui centered medium image" src="{{ $image->location }}" onerror="brokenImageHandling(this, {{$image->id}})"
          onload="removeSpecificLoader({{$image->id}})" onabort="removeSpecificLoader({{$image->id}})">
      </div>
      @endforeach
    </div>
  </div>
