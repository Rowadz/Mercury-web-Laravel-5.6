      ...
      <div class="row">
            <div class="card blue-grey darken-1 z-depth-5 pulse">
              <div class="card-content white-text">
                ...
                <p>If accepted any request the page will refresh, So if you forgot the person name just go to your profile and see the requests you accepted</p>
              </div>
            </div>
        </div>
                ...
                <div class="card z-depth-5 exchangeRequest" data-aos="flip-left" id="exchangeRequest-{{$exchangeRequest->id}}">
                        ...
                        <div class="card-content">
                           ...
                           <p>
                              ...
                              <a class="btn-floating btn-large cyan lighten-4 pulse modal-trigger-custom waves-effect waves-red" data-exchange-request-id="{{$exchangeRequest->id}}"
                                   data-auth-user-post-id="{{$exchangeRequest->post->id}}" data-post-id="{{$exchangeRequest->theOtherPost->id}}" >
